...
sudo apt-get -y --no-install-recommends install unzip wget waybar kitty nautilus xwayland wlogout wofi dunst pipx python3-dev libgirepository1.0-dev python3-importlib-metadata python3-imageio gir1.2-gtk-3.0 libgtk-4-dev imagemagick policykit-1-gnome
...
sudo apt-get -y install fonts-liberation fonts-liberation-sans-narrow
